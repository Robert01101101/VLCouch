      ...
      <section className="mb-10">
        ...
        <div className="rounded-lg border border-gray-800 bg-couch-gray/40 p-5">
          <SettingToggle
            ...
            label="Generate thumbnails for all media"
            description="Extract poster images for every movie, show, and episode. When off, thumbnails are created only when you play or mark items watched."
